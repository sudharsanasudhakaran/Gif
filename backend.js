...
function getSearch() {
    const data = document.getElementById("searchPlayList");
    if (data.value === "avatar") {
        ...
        document.getElementById("demo").src = dataList[0].avatar[6];
        document.getElementById("demo1").src = dataList[0].avatar[7];
        document.getElementById("demo2").src = dataList[0].avatar[8];
        document.getElementById("demo3").src = dataList[0].avatar[9];
        document.getElementById("demo4").src = dataList[0].avatar[10];
        document.getElementById("demo5").src = dataList[0].avatar[11];
        document.getElementById("demo5").src = dataList[0].avatar[12];
    }
    else if (data.value === "happy") {
        document.getElementById("demo").src = dataList[0].happy[0];
        document.getElementById("demo1").src = dataList[0].happy[1];
        document.getElementById("demo2").src = dataList[0].happy[2];
        document.getElementById("demo3").src = dataList[0].happy[3];
        document.getElementById("demo4").src = dataList[0].happy[4];
        document.getElementById("demo5").src = dataList[0].happy[5];
        document.getElementById("demo").src = dataList[0].happy[6];
        document.getElementById("demo1").src = dataList[0].happy[7];
        document.getElementById("demo2").src = dataList[0].happy[8];
        document.getElementById("demo3").src = dataList[0].happy[9];
        document.getElementById("demo4").src = dataList[0].happy[10];
        document.getElementById("demo5").src = dataList[0].happy[11];
        document.getElementById("demo5").src = dataList[0].happy[12];
    }
    else if (data.value === "starwars") {
        document.getElementById("demo").src = dataList[0].starwars[0];
        document.getElementById("demo1").src = dataList[0].starwars[1];
        document.getElementById("demo2").src = dataList[0].starwars[2];
        document.getElementById("demo3").src = dataList[0].starwars[3];
        document.getElementById("demo4").src = dataList[0].starwars[4];
        document.getElementById("demo5").src = dataList[0].starwars[5];
        document.getElementById("demo").src = dataList[0].starwars[6];
        document.getElementById("demo1").src = dataList[0].starwars[7];
        document.getElementById("demo2").src = dataList[0].starwars[8];
        document.getElementById("demo3").src = dataList[0].starwars[9];
        document.getElementById("demo4").src = dataList[0].starwars[10];
        document.getElementById("demo5").src = dataList[0].starwars[11];
        document.getElementById("demo5").src = dataList[0].starwars[12];
    }
    else if (data.value === "sad") {
        document.getElementById("demo").src = dataList[0].sad[0];
        document.getElementById("demo1").src = dataList[0].sad[1];
        document.getElementById("demo2").src = dataList[0].sad[2];
        document.getElementById("demo3").src = dataList[0].sad[3];
        document.getElementById("demo4").src = dataList[0].sad[4];
        document.getElementById("demo5").src = dataList[0].sad[5];
        document.getElementById("demo").src = dataList[0].sad[6];
        document.getElementById("demo1").src = dataList[0].sad[7];
        document.getElementById("demo2").src = dataList[0].sad[8];
        document.getElementById("demo3").src = dataList[0].sad[9];
        document.getElementById("demo4").src = dataList[0].sad[10];
        document.getElementById("demo5").src = dataList[0].sad[11];
        document.getElementById("demo5").src = dataList[0].sad[12];
    }
    function getSearchData() {
        let search = document.getElementById("searchTheme");
