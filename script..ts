...
function getSearch() {
  ...
  if (data.value === "avatar") {
    ...
    (document.getElementById("demo6") as HTMLImageElement).src = dataList[0].avatar[6];
    (document.getElementById("demo7") as HTMLImageElement).src = dataList[0].avatar[7];
    (document.getElementById("demo8") as HTMLImageElement).src = dataList[0].avatar[8];
    (document.getElementById("demo9") as HTMLImageElement).src = dataList[0].avatar[9];
    (document.getElementById("demo10") as HTMLImageElement).src = dataList[0].avatar[10];
    (document.getElementById("demo11") as HTMLImageElement).src = dataList[0].avatar[11];
  }
    ...
    (document.getElementById("demo6") as HTMLImageElement).src = dataList[1].happy[6];
    (document.getElementById("demo7") as HTMLImageElement).src = dataList[1].happy[7];
    (document.getElementById("demo8") as HTMLImageElement).src = dataList[1].happy[8];
    (document.getElementById("demo9") as HTMLImageElement).src = dataList[1].happy[9];
    (document.getElementById("demo10") as HTMLImageElement).src = dataList[1].happy[10];
    (document.getElementById("demo11") as HTMLImageElement).src = dataList[1].happy[11];

  }
  else if (data.value === "starwars") {
    (document.getElementById("demo") as HTMLImageElement).src = dataList[2].starwars[0];
    (document.getElementById("demo1") as HTMLImageElement).src = dataList[2].starwars[1];
    (document.getElementById("demo2") as HTMLImageElement).src = dataList[2].starwars[2];
    (document.getElementById("demo3") as HTMLImageElement).src = dataList[2].starwars[3];
    (document.getElementById("demo4") as HTMLImageElement).src = dataList[2].starwars[4];
    (document.getElementById("demo5") as HTMLImageElement).src = dataList[2].starwars[5];
    (document.getElementById("demo6") as HTMLImageElement).src = dataList[2].starwars[6];
    (document.getElementById("demo7") as HTMLImageElement).src = dataList[2].starwars[7];
    (document.getElementById("demo8") as HTMLImageElement).src = dataList[2].starwars[8];
    (document.getElementById("demo9") as HTMLImageElement).src = dataList[2].starwars[9];
    (document.getElementById("demo10") as HTMLImageElement).src = dataList[2].starwars[10];
    (document.getElementById("demo11") as HTMLImageElement).src = dataList[2].starwars[11];

  }
  else if (data.value === "sad") {
    (document.getElementById("demo") as HTMLImageElement).src = dataList[3].sad[0];
    (document.getElementById("demo1") as HTMLImageElement).src = dataList[3].sad[1];
    (document.getElementById("demo2") as HTMLImageElement).src = dataList[3].sad[2];
    (document.getElementById("demo3") as HTMLImageElement).src = dataList[3].sad[3];
    (document.getElementById("demo4") as HTMLImageElement).src = dataList[3].sad[4];
    (document.getElementById("demo5") as HTMLImageElement).src = dataList[3].sad[5];
    (document.getElementById("demo6") as HTMLImageElement).src = dataList[3].sad[6];
    (document.getElementById("demo7") as HTMLImageElement).src = dataList[3].sad[7];
    (document.getElementById("demo8") as HTMLImageElement).src = dataList[3].sad[8];
    (document.getElementById("demo9") as HTMLImageElement).src = dataList[3].sad[9];
    (document.getElementById("demo10") as HTMLImageElement).src = dataList[3].sad[10];
    (document.getElementById("demo11") as HTMLImageElement).src = dataList[3].sad[11];
  }
